...
function aa(a){return function(b,c){l.isValidElement(b)?p("228"):void 0;W.isCompositeComponent(b)?p("229"):void 0;var e=P.eventNameDispatchConfigs[a],d=new U;d.target=b;d.type=a.toLowerCase();var k=S.getInstanceFromNode(b),f=new w(e,k,d,b);f.persist();g(f,c);e.phasedRegistrationNames?Q.accumulateTwoPhaseDispatches(f):Q.accumulateDirectDispatches(f);m.unstable_batchedUpdates(function(){R.enqueueStateRestore(b);M.runEventsInBatch(f,!0)});R.restoreStateIfNeeded()}}
function X(){W.Simulate={};var a=void 0;for(a in P.eventNameDispatchConfigs)W.Simulate[a]=aa(a)}var ba=M.injection.injectEventPluginOrder;M.injection.injectEventPluginOrder=function(){ba.apply(this,arguments);X()};var ca=M.injection.injectEventPluginsByName;M.injection.injectEventPluginsByName=function(){ca.apply(this,arguments);X()};X();
function da(a,b){return function(c,e){var d=new U(a);g(d,e);W.isDOMComponent(c)?(c=K(c),d.target=c,T.dispatchEvent(b,d)):c.tagName&&(d.target=c,T.dispatchEvent(b,d))}}
...
"touchStart"],[J,"transitionEnd"],["volumechange","volumeChange"],["waiting","waiting"],["wheel","wheel"]].forEach(function(a){var b=a[1];W.SimulateNative[b]=da(b,a[0])});var Y={default:W},Z=Y&&W||Y;module.exports=Z.default?Z.default:Z;
